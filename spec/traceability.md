...
- 對映粒度：**分組級**（不逐條 assert；驗收判定單位是分組全綠）。
...
| 16 | spawn 核心＋cap＋原子回滾 | CLI-SPAWN-1, CLI-SPAWN-2, CLI-SPAWN-3, CLI-SPAWN-4, ENV-SPAWN-1, ENV-HOOKS-1, ENV-PASS-1, ENV-TAG-1, HOOK-BIND-1, STATE-AGENT-1, STATE-AGENT-5, STATE-AGENT-6 |
